    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            <label className=" text-sm font-medium text-gray-900 block mb-2">Mode de déblocage</label>

            <div className="radio">
              <input className="mr-2" type="radio" value="Souple" checked />
              Souple
            </div>

            <div className="radio">
              <input className="mr-2" type="radio" value="Mixte" />
              Mixte
            </div>

            <div className="radio">
              <input className="mr-2" type="radio" value="Stricte" />
              Stricte
            </div>
          </div>
