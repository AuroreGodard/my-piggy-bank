...
function HeaderMenu() {
  return (
    <header className="h-[70px] w-screen flex items-center fixed top-0 justify-between px-5 space-x-10 bg-[#C9DECE]">

      {/* Logo */}
      <NavLink to="/">
        <div className="text-slate-600 p-2 rounded-sm uppercase flex gap-2 items-center">
