...
function MemberCard({
  photo, color, name, title, teamRole, linkedin,
}) {
  return (
    <>
      {/* member card */}
      <a href={linkedin} target="_blank" rel="noreferrer" className="member-card h-76 w-48 shadow-md rounded-md px-2 py-6" key={name}>
