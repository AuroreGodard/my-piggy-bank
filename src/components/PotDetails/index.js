    ...
    >
      ...
      <div>
        ...
        <section className="flex w-full flex-col lg:flex-row">
          ...
          >
            <div className="flex">
              <div className="flex justify-center items-center h-32 w-32 bg-[#FFD9E0] m-2 p-2 rounded-lg">
      ...
      <div className="flex items-center gap-1">
        ...
        <div>
          {date(potDatas.dateGoal)}
            ...
            <div style={{ display: `${bar}` }} className="mt-2 mx-2 bg-[#8097A7] rounded-full">
              {/* Progress bar */}
              <div className="mt-2 flex justify-start text-center rounded-full ">
                <div className=" bg-[#C9DECE] text-black text-sm inline-block px-2 rounded-full" style={{ width: `${progressBarFullPotNull(Math.round((potDatas.amount / potDatas.amountGoal) * 100))}` + '%', minWidth: '15%' }}>
